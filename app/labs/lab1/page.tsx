...
tag to tell browsers to render the gaps.
                ...
                <div id="wd-your-favorite-recipe">
                    My favorite recipe --- How to fry good tasty beans: 
                    <ol id="wd-beans">
                        <li>Get canned or stove cooked beans</li>
                        <li>Make sure the beans are seasoned with salt</li>
                        <li>Cut half an onion, garlic, tomatoes</li>
                        <li>Heat up a pot for some oil</li>
                        <li>Pour cooking oil into the pot once it's hot</li>
                        <li>Add the chopped ingredients and stir-fry</li>
                        <li>Add the seasoning of your choice to taste</li>
                        <li>Add the beans and continue stiring</li>
                        <li>Bon appétit!</li>


                    </ol>
                    <h5>Unorderd List Tag</h5>
                    ...
                    <ul id="wd-your-books">
                        <li>So I Married the Anti-Fan</li>
                        <li>Her Private Life</li>
                        <li>Harry Potter</li>
                    </ul>
                    {/** Continue here: 1.3.5 Tabulating Data with the HTML Table Tags jga
 page 13 */}
                </div>
                <div id = "wd-tables">
                    <h4> Table Tag </h4>
                    ...
                    <input type="range"
                        ...
                        <a href="https://github.com/winniechuma/kanbas-next-js" id="wd-gitub"> click here </a>
